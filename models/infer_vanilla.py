...
encoder_outputs, state_h = model.get_layer('simple_rnn_1')(enc_x)
...
decoder_outputs, state_h = model.get_layer('simple_rnn_2')(enc_y, initial_state=decoder_state_input_h)
...
if __name__ == '__main__':
    ...
    with open('generated_comments_vanilla.txt', 'w') as file:
